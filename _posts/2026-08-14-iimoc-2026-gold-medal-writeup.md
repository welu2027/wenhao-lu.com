...
<figure class="pdf-embed pdf-embed-fit">
  <iframe src="{{ '/assets/pdf/IIMOC_2026_Certificate.pdf' | relative_url }}#view=Fit&toolbar=0&navpanes=0&scrollbar=0" title="IIMOC 2026 certificate" loading="lazy"></iframe>
</figure>

### Solutions

<figure class="pdf-embed">
  <iframe src="{{ '/assets/pdf/IIMOC_2026_Solutions.pdf' | relative_url }}" title="IIMOC 2026 solutions" loading="lazy"></iframe>
</figure>
