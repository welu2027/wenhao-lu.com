...
<div class="page-anim">
    ...
    <article class="init-card">
      <a class="init-logo" href="https://nxthorizon.org/" target="_blank" rel="noopener">
        <img src="{{ '/assets/img/nxthorizon-logo.png' | relative_url }}" alt="NXT Horizon" loading="lazy" width="128" height="128">
      </a>
      <div class="init-body">
        <h2 class="init-name"><a href="https://nxthorizon.org/" target="_blank" rel="noopener">NXT Horizon</a></h2>
    ...
    <article class="init-card">
      <a class="init-logo" href="https://yimo-official.org/" target="_blank" rel="noopener">
        <img src="{{ '/assets/img/yimo-logo.png' | relative_url }}" alt="Youth International Math Olympiad" loading="lazy" width="399" height="408">
      </a>
      <div class="init-body">
