...
<div style="float:right; margin:0 0 1rem 1.5rem; text-align:center; display:flex; gap:0.5rem; align-items:flex-start;">
  <img src="{{ '/assets/img/wellesley.png' | relative_url }}" alt="Wellesley College" style="width:90px; border-radius:6px;">
  <img src="{{ '/assets/img/imd.png' | relative_url }}" alt="Institute for Mathematics and Democracy" style="width:90px; border-radius:6px;">
</div>
...
<img src="{{ '/assets/img/bridgewater.png' | relative_url }}" alt="Bridgewater Internal Medicine" style="float:right; width:110px; margin:0 0 1rem 1.5rem; border-radius:6px;">
